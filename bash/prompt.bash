...
if tput setaf 1 &> /dev/null; then
  ...
  if [[ "$(tput colors)" -ge 256 ]] &> /dev/null; then
    sexy_bash_prompt_preposition_color="$(tput setaf 7)" # WHITE
    sexy_bash_prompt_dir_color="$sexy_bash_prompt_bold$(tput setaf 39)" # BOLD CYAN
    sexy_bash_prompt_git_status_color="$(tput setaf 154)" # BOLD YELLOW
    sexy_bash_prompt_git_progress_color="$(tput setaf 9)" # BOLD RED
  else
  # Otherwise, use colors from our set of 8
    sexy_bash_prompt_preposition_color="$(tput setaf 7)" # WHITE
    sexy_bash_prompt_dir_color="$sexy_bash_prompt_bold$(tput setaf 6)" # BOLD CYAN
    sexy_bash_prompt_git_status_color="$(tput setaf 3)" # BOLD YELLOW
    sexy_bash_prompt_git_progress_color="$(tput setaf 1)" # BOLD RED
  fi
...
# Otherwise, use ANSI escape sequences for coloring
  ...
  sexy_bash_prompt_dir_color="\033[1;36m" # CYAN
...
sexy_bash_prompt_margin="\n"

# Define the sexy-bash-prompt
PS1="$sexy_bash_prompt_margin\[$sexy_bash_prompt_dir_color\]\w\[$sexy_bash_prompt_reset\]\
